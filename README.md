...
Мой калькулятор на языке программирования Go.

Это тестовое задание для (пока неназванной школы).
Вот ТЗ, которое я получил:
...
То, что у меня получилось можно посмотреть в файле main.go
